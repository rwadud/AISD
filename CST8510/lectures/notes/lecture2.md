...
When you build an LLM application like a RAG system, you know the input and the final answer, but you need to see **what happened in between**. For example: what was the LLM thinking during self reflection? What contexts were retrieved from the vector database? To evaluate each component, you need to log these intermediate values somewhere. This is called **observability**.
