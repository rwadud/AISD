# Lecture 9: Artificial Intelligence Software Development

**CST8510 Week 9 — Dr. Hari M Koduvely**
...
- **Highly specialized infra** — Serving millions requests/hr

As production scale grows, the required infrastructure investment grows along with it.

## Four Layers of Infrastructure

Reading from bottom to top, the layers become **more important to data scientists**; reading top to bottom, they become **more commoditized**.
...
**Enterprise spending on cloud and data centers (2010–2020):**

- Data center hardware and software spending remained relatively flat around $75B–$95B per year from 2010–2020
- Cloud infrastructure services spending grew rapidly, from near $0 in 2010 to over $125B by 2020
- By 2020, cloud infrastructure services spending exceeded data center hardware/software spending
...
2. Featurize data
3. Branch: Train model A on extracted features / Train model B on extracted features
4. Compare A and B on test set
5. If A is better, deploy A; if B is better, deploy B
...
Data scientists → Workflow definition → Tasks → Schedulers → Orchestrators → Execute tasks on instances (using Instance pool) → Results → back to Data scientists
...
### Evaluation Criteria for ML Platform Tools
